...
def main():
    ...
    if args["--design"]:
        ...
        subprocess.check_call(f"klayout -b -r {pdk_root}/{pdk}/libs.tech/klayout/lvs/sky130.lvs -rd input={path} -rd report={report}.lvsdb -rd schematic={args['--net']} -rd target_netlist={file_name[0]}_extracted.cir -rd thr={workers_count} {switches}", shell=True)
